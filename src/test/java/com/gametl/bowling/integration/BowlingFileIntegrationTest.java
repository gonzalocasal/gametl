...
public class BowlingFileIntegrationTest {
  ...
  public void bowlingTemplateTest() throws Exception {
    ...
    Assertions.assertEquals("Alice", lines.get(6));
    Assertions.assertEquals("Pin falls\t \tX\t \tX\t \tX\t \tX\t \tX\t \tX\t \tX\t \tX\t \tX\tX\tX\tX\t", lines.get(7));
    Assertions.assertEquals("Score\t\t30\t\t60\t\t90\t\t120\t\t150\t\t180\t\t210\t\t240\t\t270\t\t300\t\t", lines.get(8));

    Assertions.assertEquals("", lines.get(9));

    Assertions.assertEquals("Frame\t\t1\t\t2\t\t3\t\t4\t\t5\t\t6\t\t7\t\t8\t\t9\t\t10", lines.get(10));
    Assertions.assertEquals("Jeff", lines.get(11));
    Assertions.assertEquals("Pin falls\t \tX\t7\t/\t9\t0\t \tX\t0\t8\t8\t/\tF\t6\t \tX\t \tX\tX\t8\t1\t", lines.get(12));
    Assertions.assertEquals("Score\t\t20\t\t39\t\t48\t\t66\t\t74\t\t84\t\t90\t\t120\t\t148\t\t167\t\t", lines.get(13));

    Assertions.assertEquals("", lines.get(14));

    Assertions.assertEquals("Frame\t\t1\t\t2\t\t3\t\t4\t\t5\t\t6\t\t7\t\t8\t\t9\t\t10", lines.get(15));
    Assertions.assertEquals("John", lines.get(16));
    Assertions.assertEquals("Pin falls\t3\t/\t6\t3\t \tX\t8\t1\t \tX\t \tX\t9\t0\t7\t/\t4\t4\tX\t9\t0\t", lines.get(17));
    Assertions.assertEquals("Score\t\t16\t\t25\t\t44\t\t53\t\t82\t\t101\t\t110\t\t124\t\t132\t\t151\t\t", lines.get(18));
